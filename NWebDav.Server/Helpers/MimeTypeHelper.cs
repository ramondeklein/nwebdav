...
{
    private static readonly Dictionary<string, string> s_typeMap = new(StringComparer.OrdinalIgnoreCase)
    {
    ...
    /// </summary>
    public static string FallbackMimeType => "application/octet-stream";
    ...
    public static string GetMimeType(string fileName)
    {
        ...
        if (!string.IsNullOrEmpty(extension) && s_typeMap.TryGetValue(extension[1..].ToLowerInvariant(), out var mimeType))
            return mimeType;
