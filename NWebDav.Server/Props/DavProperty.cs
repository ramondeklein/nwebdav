...
public abstract class DavProperty<TEntry> where TEntry : IStoreItem
{
    ...
    /// </remarks>
    public Func<TEntry, CancellationToken, Task<object?>>? GetterAsync { get; set; }
    ...
    public Func<TEntry, object, CancellationToken, Task<DavStatusCode>>? SetterAsync { get; set; }
